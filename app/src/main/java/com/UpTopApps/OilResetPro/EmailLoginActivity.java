...
public class EmailLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void doLogin(){
        ...
        final String url = url2+"?push_token=push_token&platform=ANDROID&email="+email+"&password="+password;
                        ...
                        try {
                         ...
                         //   Log.d("Response: ",  res);
                            if(res.equals("success")){
                                ...
                                editor.putString(Constants.FIRST_NAME, response.getString("first_name"));
                                editor.putString(Constants.LAST_NAME, response.getString("last_name"));
